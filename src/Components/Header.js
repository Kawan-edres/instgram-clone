...
const Header = () => {
  ...
  return (
    ...
    <nav className=" max-w-[1000px] mt-2 mx-auto flex	 justify-between items-center h-10  ">
      ...
      <form className="search h-[36px]  min-w-[140px] w-[260px]  flex short:hidden 	 ">
      ...
      <NavBar to="/inbox" iconName="inbox" badge={3} />
